      ...
      {discoveredAlloys.length === 0 ? (
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6">
          {discoveredAlloys.map((alloy) => (
            <div key={alloy.id} className="bg-white p-4 rounded-md shadow border border-gray-200 hover:shadow-md transition-shadow">
              <div className="mb-3">
                ...
                ></div>
                <h3 className="font-semibold text-gray-700 text-center text-base">{alloy.name}</h3>
              </div>
